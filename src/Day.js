  ...
  if (!isSameDay(currentMessage, previousMessage)) {
    return (
      <View style={[styles.container, containerStyle]}>
        <View style={{ position: 'absolute', top: 8.5, left: 10, right: 10, height: 0.7, backgroundColor: '#dadadc' }}>

        </View>
        <View style={[wrapperStyle, { zIndex: 999, backgroundColor: '#fff', paddingLeft: 8, paddingRight: 8 }]}>
